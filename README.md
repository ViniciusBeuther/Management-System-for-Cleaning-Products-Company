...
## Technologies Used
* **Relational database**: MySQL, Lucid Chart for ER Diagram.
* **Back-end**: Javascript (Node.js) for the backend, JWT, Express.js, BCrypt.
* **Front-end**: React.js, Tailwind Css and Shadcn.
